...
| `GET /api/tenants/qr` | Sesión + membresía | QR SVG descargable con campaña opcional |
...
│                        demo · site
├── supabase/            schema.sql + migration_3_2_0 … migration_3_13_0.sql
